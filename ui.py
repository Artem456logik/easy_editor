...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(0, 509, 801, 31))
        ...
        self.files_list.setGeometry(QtCore.QRect(0, 40, 161, 461))
        self.files_list.setObjectName("files_list")
        self.chose_dir_btn = QtWidgets.QPushButton(parent=self.centralwidget)
        self.chose_dir_btn.setGeometry(QtCore.QRect(0, 10, 161, 28))
        self.chose_dir_btn.setObjectName("chose_dir_btn")
        self.image_lb = QtWidgets.QLabel(parent=self.centralwidget)
        self.image_lb.setGeometry(QtCore.QRect(174, 15, 601, 481))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.chose_dir_btn.setText(_translate("MainWindow", "Папка"))
